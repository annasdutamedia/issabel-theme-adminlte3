...
<form class="issabel-standard-formgrid" id="idformgrid" method="POST" style="margin-bottom:0;display:flex;flex-direction:column;" action="{$url}">
...
<input type="submit" name="" value="" style="height: 0; min-height: 0; font-size: 0; width: 0; border: none; outline: none; padding: 0px; margin: 0px; box-sizing: border-box; float: left;" />
    ...
    {*<div class="neo-table-ref-table">*}
        ...
        <div class="table-responsive" style="overflow-y: auto;padding-bottom:10px;">
        <div class="table-wrap">
        <table class="issabel-standard-table table table-bordered" align="center" width="100%" >
        <thead>
            <tr>
