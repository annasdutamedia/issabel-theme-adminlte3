...
<div class="login-box" style="margin:3% auto !important;">
  <div class="login-logo">
    <a style="display: none;" href="#"><img src="<?=base_url('assets/dist/img/PPU_LOGO.png')?>"></a>
  </div>
  <!-- /.login-logo -->
  <?php
  ...
  <div class="login-box-body">
    ...
    <form method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Extension" name="email" value="<?=isset($email)?$email:'';?>">
